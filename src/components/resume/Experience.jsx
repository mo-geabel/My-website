  ...
  return (
    <section id="experience" className="py-12 md:py-16 bg-gray-50 dark:bg-gray-800">
      <div className="section-container">
        <h2 
          className="text-2xl md:text-3xl font-bold mb-8 text-gray-900 dark:text-white flex items-center"
          data-aos="fade-up"
        >
        ...
        <div className="space-y-8">
          {sortedExperiences.map((experience, index) => (
            <div 
              key={experience.id} 
              className="card bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 hover-lift"
              data-aos="fade-up"
                ...
                <div data-aos="fade-up" data-aos-delay={(index * 100) + 200}>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700 dark:text-gray-300">
                    {experience.achievements.map((achievement, i) => (
                      <li 
                        key={i} 
                        className="ml-2 transition-all duration-300 hover:translate-x-2"
                      >
                        {achievement}
                      </li>
                    ))}
